...
madlib = f"Computer programming is so {random.choice (Adjectives)}! It makes me so excited all the time because \
I love to {random. choice (Verb1)}. Stay hydrated and {random.choice (Verb2)} like you are {random.choice(famous_person)}!"
